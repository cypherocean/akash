...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('portfolio.insert') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea name="description" id="description" class="form-control" cols="30" rows="10" placeholder="Plese enter description" value="{{ @old('description') }}"></textarea>
                                <span class="kt-form__help error description"></span>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="control-label">Upload Thumbnail</label>
                                <input type="file" name="thumbnail" id="thumbnail" class="dropify" data-default-file="{{ $data->thumbnail ??'' }}" data-allowed-file-extensions="jpg png jpeg" data-max-file-size-preview="2M">
                                <span class="kt-form__help error thumbnail"></span>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="control-label">Upload Images</label>
                                <input type="file" name="images[]" id="images" class="dropify" data-default-file="{{ $data->images ??'' }}" data-allowed-file-extensions="jpg png jpeg" data-max-file-size-preview="2M" multiple>
