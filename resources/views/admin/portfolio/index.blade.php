    ...
    <div class="row">
        ...
        <div class="col-5 align-self-center">
            <div class="customize-input float-right">
                <a class="btn waves-effect waves-light btn-rounded btn-outline-primary pull-right" href="{{ route('portfolio.create') }}">Add New</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function change_status(object) {
        ...
        if (confirm('Are you sure?')) {
            $.ajax({
                "url": "{!! route('portfolio.change_status') !!}",
                "dataType": "json",
                "type": "POST",
                "data": {
                    id: id,
