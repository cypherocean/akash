                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <textarea name="description" id="description" class="form-control" cols="30" rows="10" placeholder="Plese enter description" disabled>{{ $portfolio->description ??'' }}</textarea>
                                <span class="kt-form__help error description"></span>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="control-label">Upload Thumbnail</label>
                                <input type="file" name="thumbnail" id="thumbnail" class="dropify" data-default-file="{{ url('uploads/portfolio/' , $portfolio->thumbnail_image) ??'' }}" data-allowed-file-extensions="jpg png jpeg" data-max-file-size-preview="2M" disabled>
                                <span class="kt-form__help error thumbnail"></span>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="control-label">Upload Images</label>
                                <input type="file" name="images[]" id="images" class="dropify" data-default-file="{{ url('uploads/portfolio/' ,$portfolio_images[0]->images) }}" data-allowed-file-extensions="jpg png jpeg" data-max-file-size-preview="2M" multiple disabled>
